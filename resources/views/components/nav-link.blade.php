...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#F1E8D8] text-sm font-medium leading-5 text-[#F7F4D5] focus:outline-none focus:border-[#D3968C] transition duration-150 ease-in-out'
